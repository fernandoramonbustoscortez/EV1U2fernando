...
namespace MercDevs_ej2.Controllers
{
    public class DescripcionserviciosController : Controller
    {
        ...
        //desde aqui para arriba es nativo del crud
        public async Task<IActionResult> DescripcionporId(int? id)
        {
            var mercydevsEjercicio2Context = _context.Descripcionservicios.Where(u => u.ServicioIdServicio == id).Include(d => d.ServicioIdServicioNavigation);
            return View(await mercydevsEjercicio2Context.ToListAsync());
        }
    }
}
